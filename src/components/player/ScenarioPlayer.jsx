...
export function ScenarioPlayer(props){
  ...
  return(<div className={shake?"bw-shake":""} style={{minHeight:"100dvh",padding:16,background:"linear-gradient(135deg,#0a0e1a,#1a1a3e)",color:"#fff"}}>
    ...
    <div className="bw-container" style={{maxWidth:480,margin:"0 auto"}}>
      ...
      {stage==="assess"&&<AssessPanel ph={ph} vit={vit} curSigns={curSigns} curLabs={curLabs} flags={flags} showFb={showFb} submit={submit} afterA={afterA} flag={flag} patient={sc.patient} ageGroup={ageG} sex={sexG} visuals={scVisuals} seed={pSeed} status={pSt()} norms={sc.norms} phaseIdx={pi} prevAssess={pi>=2&&sc.phases&&sc.phases[0]?sc.phases[0]:null}/>}
