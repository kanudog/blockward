...
export function VitalsDisplay(props){
  ...
  var vs=[{l:"HR",k:"hr",v:vitals.hr,u:"bpm"},{l:"SpO2",k:"spo2",v:vitals.spo2,u:"%"},{l:"RR",k:"rr",v:vitals.rr,u:"/min"},{l:"BP",k:"sbp",v:vitals.sbp+"/"+vitals.dbp,u:"mmHg"},{l:"Temp",k:"temp",v:typeof vitals.temp==="number"?vitals.temp.toFixed(1):vitals.temp,u:"C"},{l:"Cap Refill",k:"cap",v:vitals.cap,u:"sec"}];
  return(
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:4,padding:8,background:"#0d1117"}}>
        {vs.map(function(v){
          ...
          if(revealed){
            ...
            else if(v.l==="Temp"&&(v.v<36.5||v.v>37.5))vColor="#ff7675";
          }
          return(
