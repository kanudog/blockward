  ...
  "phases": [
    {
      ...
      "assessItems": [
        ...
        },
        {
          ...
          "label": "Pupils",
          "bad": true,
          "why": "Bilateral 1–2 mm non-reactive pupils are the pathognomonic finding of opioid toxidrome.\n\n- **Mu-opioid receptor** activation in the Edinger-Westphal nucleus produces sustained, unopposed parasympathetic miosis\n- This finding is bilateral and symmetric — distinguishing it from **herniation** (unilateral, fixed, dilated) or pontine hemorrhage (bilateral pinpoint but with other brainstem signs)\n- Non-reactivity confirms **opioid receptor saturation** not yet reversed by prior intranasal naloxone dose\n- Will normalize to mid-position reactive pupils after adequate **naloxone re-dosing**",
          "cat": "clinical"
        },
        {
          ...
          "label": "Respiratory Effort",
          "bad": true,
          "why": "RR 8/min with shallow tidal volumes and intermittent apnea is a critical finding demanding immediate airway intervention.\n\n- **Central hypoventilation** driven by mu-opioid receptor suppression of the pre-Bötzinger complex in the medulla\n- Intermittent apnea of 5–8 seconds signals **impending respiratory arrest** — the partial naloxone reversal is waning\n- Shallow tidal volumes mean even the documented respiratory rate overstates effective **alveolar ventilation**\n- Requires **assisted ventilation** (BVM) immediately while naloxone is re-dosed IV",
          "cat": "clinical"
        },
        {
          "id": "loc",
          "label": "Level of Consciousness",
          "bad": true,
          "why": "GCS 8 defines an inability to protect the airway and signals significant CNS depression.\n\n- **GCS ≤ 8** is the classic threshold for evaluating need for definitive airway management\n- In opioid overdose, CNS depression reflects mu-receptor-mediated suppression across cortex, limbic system, and brainstem reticular activating system\n- GCS 8 here (E2V2M4) shows the **partial effect** of prior naloxone — GCS was presumably lower at the scene before the intranasal dose\n- Clinical priority: re-dose **naloxone IV** to avoid intubation if reversal can be achieved rapidly",
          "cat": "clinical"
        },
        {
          "id": "skin",
          "label": "Skin Assessment",
          "bad": true,
          "why": "Pale, cool, diaphoretic skin with cap refill 3 sec reflects impaired peripheral perfusion and opioid-mediated vasomotor changes.\n\n- **Pallor and diaphoresis** result from sympathoadrenal activation in response to hypoxia, combined with opioid-induced peripheral vasodilation\n- Cap refill 3 sec (normal: < 2 sec) confirms **reduced microcirculatory flow**\n- Absence of cyanosis is the one reassuring element — overt peripheral hypoxia has not yet supervened\n- Absence of rash or track marks is clinically relevant: rules out anaphylaxis, informs likely **route of ingestion** (oral pill)",
          "cat": "clinical"
        },
        {
          ...
          "label": "Lung Auscultation",
          "bad": false,
          "why": "Equal bilateral breath sounds without wheezing or crackles is a reassuring finding in this clinical context.\n\n- **Equal air entry bilaterally** confirms no pneumothorax, hemothorax, or main-stem intubation — critical to establish before BVM or RSI\n- No crackles argues against **aspiration pneumonitis** at this time, though risk remains elevated with GCS 8\n- No wheezing excludes **bronchospasm** as a contributor to the hypoxemia — this is pure central hypoventilation\n- Midline trachea is confirmed — no mediastinal shift",
          "cat": "clinical"
        },
        {
          ...
          "label": "Cardiac Auscultation",
          "bad": false,
          "why": "Bradycardic but regular rhythm with normal heart sounds is reassuring against structural and arrhythmic pathology.\n\n- **Regular rhythm** without murmur, gallop, or rub argues against primary cardiac disease or co-ingested QT-prolonging agent as the driver\n- S1/S2 present and normal — no structural lesion causing the presentation\n- The bradycardia (HR 58) is flagged separately under vitals as the opioid-mediated element\n- This compound finding as a whole is **not flagworthy for structural concern** — the rate elevation is the only actionable element and is captured in the HR vital",
          "cat": "clinical"
        },
        {
          "id": "glucose",
        ...
        },
        {
          ...
          "label": "Venous pH",
          "bad": true,
          "why": "Venous pH of 7.22 indicates significant acidemia, consistent with respiratory acidosis from hypoventilation.\n\n- Normal venous pH: **7.32–7.40**; 7.22 reflects accumulation of CO2 driving carbonic acid formation\n- In opioid-induced hypoventilation, **PaCO2 rises** as alveolar ventilation falls, shifting the Henderson-Hasselbalch equilibrium toward acidemia\n- This is a **respiratory acidosis** — the primary derangement is elevated CO2, not metabolic acid production\n- Elevated lactate (see below) suggests a superimposed **metabolic acidosis** component from tissue hypoxia",
          "cat": "lab"
        },
        {
          "id": "venous-co2",
          "label": "Venous pCO2",
          "bad": true,
          "why": "Venous pCO2 of 72 mmHg is markedly elevated, confirming severe hypoventilation.\n\n- Normal venous pCO2: **41–51 mmHg**; 72 mmHg represents **hypercapnic respiratory failure**\n- Rising CO2 is the direct consequence of inadequate minute ventilation (RR 8 × shallow tidal volumes)\n- **CO2 narcosis** can deepen CNS depression independently of opioid effect — worsening the hypoventilation cycle\n- Reversal of this requires **improved ventilation** (BVM-assisted breaths) AND naloxone re-dosing",
          "cat": "lab"
        },
        {
          "id": "bicarb",
        ...
        },
        {
          ...
          "label": "Lactate",
          "bad": true,
          "why": "Lactate of 3.8 mmol/L is elevated above the upper limit of normal (2.0 mmol/L), indicating tissue hypoperfusion.\n\n- Elevated lactate reflects a shift to **anaerobic metabolism** in tissues inadequately supplied with oxygen\n- In this case, the cause is **hypoxia from hypoventilation** (SpO2 89%) rather than distributive shock or cardiac failure\n- Lactate 3.8 mmol/L is in the intermediate range — not yet critically elevated (> 4 mmol/L) but indicates **oxygen delivery is failing**\n- Expected to fall rapidly with restoration of adequate ventilation and naloxone-mediated reversal",
          "cat": "lab"
        },
        {
          "id": "acetaminophen",
      ...
      "assessItems": [
        {
          ...
          "label": "Airway Patency",
          "bad": true,
          "why": "Airway patency maintained only with jaw thrust and at risk of complete obstruction — oropharyngeal muscle tone is lost from CNS depression.\n\n- **Snoring respirations** indicate posterior tongue displacement obstructing the hypopharynx\n- GCS 8 means protective airway reflexes are compromised — risk of **aspiration** if vomiting occurs\n- An **NPA** or **OPA** adjunct should be placed to maintain airway patency while naloxone takes effect\n- Clear oropharynx is reassuring now but does not guarantee future airway safety with ongoing CNS depression",
          "cat": "clinical"
        },
        {
          ...
          "label": "Ventilatory Response",
          "bad": true,
          "why": "Tidal volumes < 200 mL with RR 8/min define critically inadequate minute ventilation requiring immediate assisted breathing.\n\n- **Minute ventilation** ≈ 1,600 mL/min — far below the 5–6 L/min needed for normal CO2 clearance\n- Continuing to watch without BVM assistance risks **progressive CO2 narcosis**, cardiac arrhythmia from hypoxia, and respiratory arrest\n- BVM at 12–15 breaths/min with tidal volume targeting **6–8 mL/kg (300–400 mL)** corrects this while naloxone reversal begins\n- ETCO2 monitoring guides adequacy of manual ventilation in real time",
          "cat": "clinical"
        },
        {
          ...
          "label": "Pupillary Response",
          "bad": true,
          "why": "Unchanged pinpoint pupils confirm active opioid receptor saturation and inadequate reversal from prior naloxone dose.\n\n- Persistent **miosis** means opioid agonist continues to dominate mu-receptor binding — the IN naloxone dose was insufficient\n- Pupil normalization to **4–5 mm reactive** is a reliable, objective endpoint for adequate naloxone reversal\n- Absence of pupillary response after IV naloxone should prompt consideration of **high-potency synthetic opioid** (fentanyl analog) requiring repeat or infusion dosing\n- Pupil check every 2–3 min post-naloxone is a low-tech, high-yield monitoring tool",
          "cat": "clinical"
        },
        {
          "id": "etco2",
          "label": "ETCO2 Waveform",
          "bad": true,
          "why": "ETCO2 68 mmHg confirms severe hypercapnia from alveolar hypoventilation and demands immediate ventilatory augmentation.\n\n- **Normal waveform morphology** excludes bronchospasm — the etiology is pure **central hypoventilation**\n- ETCO2 68 is consistent with venous pCO2 72 — internally coherent confirmation of hypercapnic respiratory failure\n- Rising ETCO2 despite BVM support would be an indication to move toward **definitive airway (RSI)** rather than continued BVM bridging\n- Falling ETCO2 toward 40 mmHg during treatment confirms adequate ventilatory response",
          "cat": "clinical"
        },
        {
          "id": "iv-access",
          "label": "IV Access",
          "bad": false,
          "why": "Patent right antecubital 20-gauge IV confirmed with blood return and flush — access is established and ready for immediate drug delivery.\n\n- **IV access confirmed patent** means there is no barrier to immediate naloxone administration\n- This is a **reassuring finding** — the most time-critical bottleneck in opioid reversal (access for IV naloxone) is already resolved by EMS\n- No need for IO placement or additional IV attempts at this moment; focus on using existing access for drug delivery\n- If IV fails during resuscitation, IO in proximal tibia is the **immediate backup**",
          "cat": "clinical"
        }
      ],
      "labs": [],
      "tools": ["bvm", "etco2", "npa", "pulseOx", "defib", "intubationKit", "o2Mask", "ecg12Lead", "gastricLavage"],
      "meds": ["naloxone", "ketamine", "dextroseBolus", "lorazepam", "flumazenil", "activatedCharcoal", "nsBolus", "fentanyl"],
      "actions": {
        "tools": {
          "bvm": {
            "ok": true,
